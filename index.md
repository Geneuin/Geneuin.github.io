...
**㈜지뉴인(Geneuin Inc.)**은 2020년 1월 설립된 시스템 통합(SI) 및 IT 솔루션 전문기업으로,
복잡한 산업 환경 속에서도 기술 중심의 문제 해결력으로 고객의 비즈니스 혁신을 이끌어왔습니다.
우리는 단순한 시스템 구축에 머물지 않고, 서비스 아키텍처 설계·데이터 구조 최적화·보안·운영 자동화 등
IT 인프라의 전 생애주기를 아우르는 엔지니어링 중심의 접근 방식을 추구합니다.
공공기관, 대기업, 스타트업 등 다양한 도메인에서 쌓은 경험을 통해
Spring Boot, Vue.js, React, Node.js, PostgreSQL, 클라우드 인프라(AWS, Docker) 등
최신 기술 스택을 기반으로 확장성·안정성·보안성이 검증된 솔루션을 제공합니다.
지뉴인은 프로젝트를 수행할 때 항상 **‘기술의 깊이’와 ‘운영의 지속성’**을 핵심 가치로 두며,
각 분야의 전문 개발자들이 기획 단계부터 운영·유지보수까지 엔드-투-엔드 기술 컨설팅을 제공합니다.
우리는 빠르게 변화하는 디지털 환경 속에서도
데이터 기반의 의사결정과 자동화된 시스템 운영을 통해 고객의 기술 경쟁력을 극대화합니다.
앞으로도 지뉴인은 정확함·책임감·신뢰를 바탕으로
기술이 비즈니스를 견인하는 시대에 가장 믿을 수 있는 기술 파트너로 성장하겠습니다.
...
• 2020년
•	㈜지뉴인(Geneuin Inc.) 설립
•	초기 SI(System Integration) 프로젝트 수행 시작
•	VillaM, 장례박사, 라미체 등 서비스 플랫폼 개발 착수
•	IoT 및 의료 서비스 분야 진출을 위한 기술 기반 확립
2021년
•	K-ICT Bigdata Center 관리자 기능 유지보수 및 R-Portal 추가 개발
•	인천수자원공사 레거시 시스템 재구축
•	보건복지부 IoT 돌봄 서비스 플랫폼 구축
•	KC-Industrial MES 시스템 개발
•	클라우드·데이터 중심 아키텍처 구축 경험 확장
2022년
•	한국소방시설관리협회 차세대 시스템 구축 (eGov Framework 기반)
•	KC-Industrial 공장 모니터링 시스템 구축
•	보건복지부 IoT 돌봄 서비스 중계서버 구축
•	NFT 플랫폼 구축 (블록체인 및 디지털 자산 분야 진출)
2023년
•	Chemtopia 공공기관 안전활동수준평가 시스템 구축
•	Hwian 설치·유지보수 관리 시스템 구축
•	이건마루 카탈로그 페이지 구축
•	심빌리지 자동 발송 시스템 구축
•	IoT·공공기관·상용서비스 등 다양한 산업군으로 사업 확장
2024년
•	Teeupnjoy 골프 예약·조인 시스템 차세대 구축
•	한솔루션 홈페이지 및 복지센터 시스템 구축
•	안전보안 스마트워치 통신 프로토콜 및 관리 시스템 구축
•	Spring Boot / Vue.js / React 기반의 통합형 프레임워크 고도화
2025년
•	서울특별시 9988 서비스 유지보수 수행 중
•	공공·민간·헬스케어 전반으로 SI 서비스 포트폴리오 확대
•	AI·데이터 자동화 및 클라우드 통합 솔루션 사업 강화 중
...
<hr>
<img src="/images/home/보고싶다1.png" style="width: 13em;">
<img src="/images/home/보고싶다2.png" style="width: 13em;">
<img src="/images/home/보고싶다3.png" style="width: 12.7em;">
<img src="/images/home/보고싶다4.png" style="width: 13em;">
